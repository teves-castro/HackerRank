...
// ======== Pattern Matching ========
// Match..with.. is like a case/switch statement on steroids
...
let rec printEmp e =
    match e with
    | Worker p -> printf "%A" p
    | Manager (m, es) -> es |> Seq.map printEmp 


let jdoe = {First="John";Last="Doe"}

let john = Worker jdoe

let mike = {First="Michael";Last="Palin"}

let manager = Manager (mike, [john])
